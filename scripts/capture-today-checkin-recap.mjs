...
async function capture(state, name) {
  ...
  await page.locator('[data-kind=\"morning\"]').waitFor()
  await page.locator('[data-kind=\"evening\"]').waitFor()
...
await page.locator('[data-kind=\"morning\"] [data-complete=\"true\"]').click().catch(() => {})
