  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="rgb(var(--c-line) / 0.34)"
        strokeWidth="1"
        strokeLinecap="round"
      />

      <circle cx="72" cy="80" r="2.5" fill="rgb(var(--c-line) / 0.76)" />
      <circle cx="148" cy="80" r="2.5" fill="rgb(var(--c-line) / 0.76)" />
      <circle cx="48" cy="80" r="2" fill="rgb(var(--c-line) / 0.40)" />
      <circle cx="172" cy="80" r="2" fill="rgb(var(--c-line) / 0.40)" />
...
function MentorCardArt() {
  return (
    ...
    >
      ...
      <circle cx="62" cy="115" r="2.3" fill="rgb(var(--c-line) / 0.48)" />
      <circle cx="91" cy="96" r="2.3" fill="rgb(var(--c-line) / 0.56)" />
      <circle cx="120" cy="76" r="2.3" fill="rgb(var(--c-line) / 0.66)" />

      <circle
        cx="151"
        cy="51"
        r="18"
        stroke="rgb(var(--c-line) / 0.18)"
        strokeWidth="1"
        strokeDasharray="3 5"
      />
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="rgb(var(--c-line) / 0.56)"
        strokeWidth="1.1"
        strokeLinecap="round"
      />

      <circle cx="43" cy="118" r="2.3" fill="rgb(var(--c-line) / 0.38)" />
      <circle cx="68" cy="113" r="2.3" fill="rgb(var(--c-line) / 0.48)" />
      <circle cx="94" cy="101" r="2.5" fill="rgb(var(--c-line) / 0.58)" />
      <circle cx="122" cy="88" r="2.4" fill="rgb(var(--c-line) / 0.50)" />
      <circle cx="174" cy="60" r="2.4" fill="rgb(var(--c-line) / 0.58)" />
      <circle cx="197" cy="39" r="2.2" fill="rgb(var(--c-line) / 0.42)" />
