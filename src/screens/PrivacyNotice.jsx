    ...
    <ProfilePage title="политика и данные." onBack={onBack} testId="profile-screen-privacy">
      <section className="w-full px-[var(--mx-screen-x)]">
        ...
        <div className="mt-6 space-y-3">
          <NoticeCard icon={Database} title="Что сохраняется">
            <p>
              ...
              Завершённые направленные записи хранят immutable snapshot вопросов и ответов отдельно
              от Journey и History.
            </p>
            <p>
              Фото, видео, голосовые записи, object storage и постоянные вложения сейчас не
          ...
          <NoticeCard icon={Download} title="Срок хранения и твой контроль">
            ...
            <p>
              ...
              чек-ина и подтверждённое удаление аккаунта с owner-scoped данными. JSON export также
          ...
          <NoticeCard icon={CloudOff} title="Черновики и синхронизация">
            <p>
              Незавершённый чек-ин хранится только на текущем устройстве. Это local draft, а не
              cloud backup; его можно очистить в настройках, и он не переносится автоматически.
            </p>
            <p>
              Сохранённые данные профиля могут быть доступны после связывания с web-аккаунтом, но
              Mini App не использует iCloud. Offline queue, conflict resolution и правило
              last-write-wins не реализованы и не обещаются — не редактируй одну и ту же запись
              параллельно в нескольких сессиях.
            </p>
          </NoticeCard>
        ...
        <div className="mt-6 rounded-2xl border border-gold/20 bg-gold/5 p-4 text-[12px] leading-relaxed text-muted">
          ...
          . Мы не заявляем end-to-end encryption, iCloud backup или разрешение конфликтов, пока это
          не реализовано и не проверено.
        </div>
