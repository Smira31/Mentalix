      ...
      <div className="mt-6 space-y-3">
        ...
        <NoticeCard icon={Download} title="Срок хранения и твой контроль">
          ...
          <p>
            ...
            check-in и подтверждённое удаление аккаунта с owner-scoped данными. Удаление не обещает
            мгновенную очистку технических резервных копий: для неё пока нет отдельного
