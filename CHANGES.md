...
# Обновление 22 — Методология вокруг проблем пользователя

- Добавлена первичная карта из 15 пользовательских проблем в `docs/problems/PROBLEMS.md`.
- Для каждой проблемы зафиксированы пользовательские формулировки, причины-гипотезы, принципы, практики, контент, источники, риски и способы проверки результата.
- Добавлены методологическое правило и рабочий процесс: **проблема пользователя → принцип → практика → контент → источник**.
- Добавлен единый шаблон детальной карточки проблемы.
- `PRODUCT.md`, `README.md` и `TASKS.md` связаны с новой архитектурой и следующими этапами валидации.
- Код приложения, UI, API-контракты и зависимости не изменялись.
