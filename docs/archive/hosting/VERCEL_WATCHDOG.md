...
Исторический workflow `.github/workflows/vercel-production-watchdog.yml` удалён 16.09.2026 после перехода на Firebase Hosting Production. Этот документ сохранён только для истории и не описывает текущую автоматизацию.
