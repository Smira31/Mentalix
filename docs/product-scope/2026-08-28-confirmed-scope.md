...
The coordination documents are guidance for repository work, not permission to perform production, data, secret or account operations. Product-policy documents remain hypotheses and working constraints until user research or a later explicit product decision changes them.
