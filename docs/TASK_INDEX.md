...
| `MXL-DS-LABEL-FONT-001` |       S | design-system    | ready    | autonomous     | Диф подтверждён владельцем; открыть/обновить PR в `main`, дождаться Vercel Preview + `Telegram Preview` workflow, затем ручной gate |
