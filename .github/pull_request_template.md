...
**Входы:** Issue, документы, код или evidence, на которые опирается PR.

**Изменяемые файлы и границы:**

**Намеренно не меняется:** product logic, API, данные, secrets, production или deployment — укажите явно, если применимо.

**Критерий результата:** наблюдаемый результат, по которому PR можно принять.

**Ручной gate:** `не требуется` или точная проверка владельца на Preview/Telegram/iPhone.
