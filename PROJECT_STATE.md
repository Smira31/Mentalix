...
- **Backlog:** `MXL-007`, `MXL-008`, `MXL-021` и `MXL-011` завершены; `MXL-005` находится в реализации по утверждённому baseline. Остальные активные записи остаются в backlog.
